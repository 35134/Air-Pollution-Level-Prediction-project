...
def main():
    ...
    try:
        ...
        train_df = pd.read_csv('data/cleaned/train_cleaned.csv', index_col=0, parse_dates=True)
        val_df = pd.read_csv('data/cleaned/val_cleaned.csv', index_col=0, parse_dates=True)
        test_df = pd.read_csv('data/cleaned/test_cleaned.csv', index_col=0, parse_dates=True)
        ...
        train_eng = pd.read_csv('data/cleaned/train_engineered_optimized.csv', index_col=0, parse_dates=True)
        val_eng = pd.read_csv('data/cleaned/val_engineered_optimized.csv', index_col=0, parse_dates=True)
        test_eng = pd.read_csv('data/cleaned/test_engineered_optimized.csv', index_col=0, parse_dates=True)
        ...
        # Save models
        baseline_model.save_model('results/baseline_model.pkl')
        optimized_model.save_model('results/optimized_model.pkl')
