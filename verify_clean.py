...
def main():
    ...
    essential_files = [
        ...
        "src/models.py",
        "src/__init__.py",
        "datasets/data/metadata.json",
        "datasets/data/cleaned/train_cleaned.csv",
        "datasets/data/cleaned/val_cleaned.csv", 
        "datasets/data/cleaned/test_cleaned.csv",
        "datasets/data/cleaned/train_engineered_optimized.csv",
        "datasets/data/cleaned/val_engineered_optimized.csv",
        "datasets/data/cleaned/test_engineered_optimized.csv",
